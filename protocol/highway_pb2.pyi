...
class Device(_message.Message):
    __slots__ = ("device_type", "message_type", "id", "token")
    ...
    id: int
    token: str
    def __init__(self, device_type: _Optional[_Union[Device.DeviceType, str]] = ..., message_type: _Optional[_Union[Device.MessageType, str]] = ..., id: _Optional[int] = ..., token: _Optional[str] = ...) -> None: ...

class Register(_message.Message):
    __slots__ = ("device", "subscribe_device")
    DEVICE_FIELD_NUMBER: _ClassVar[int]
    SUBSCRIBE_DEVICE_FIELD_NUMBER: _ClassVar[int]
    device: Device
    subscribe_device: Device
    def __init__(self, device: _Optional[_Union[Device, _Mapping]] = ..., subscribe_device: _Optional[_Union[Device, _Mapping]] = ...) -> None: ...
